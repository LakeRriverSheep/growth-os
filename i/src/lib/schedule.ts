// 26软件工程（专升本）· 2026 秋季学期课表（第 3-19 周 / 9.14-2027.1.10，考试 1.11-1.13）
// 来源：班级课表（26.9.4）.xlsx + 校历 + 教务处课调通知（9/16 教室调整）
// 课表按星期几重复；单双周写在 weeks 字段里（如 "4-18双"），由 courseOnWeek 过滤
// 已含 9/16 教室调整：周三 1-4 节《软件工程》图书馆5楼16机房 → 图书馆5楼5机房
...
// 节次 → 起止时间（与课表附页「作息」一致：每节 45 min，两节连上）
// 上午 1 节 08:20-09:05 · 2 节 09:15-10:00 ｜ 3 节 10:20-11:05 · 4 节 11:15-12:00
// 下午 5 节 14:30-15:15 · 6 节 15:25-16:10 ｜ 7 节 16:30-17:15 · 8 节 17:25-18:10
// 晚上 9 节 19:00-19:45 · 10 节 19:55-20:30
// ⚠ 19:30-21:20 是「大一晚修」时间，专升本不适用，别拿它当 9-10 节
...
export const CLASS_SCHEDULE: Course[] = [
  ...
  // 周三
  mk("wed1", "周三", "1-2", "软件工程", "甘利", "图书馆5楼5机房", "3-19"),
  mk("wed2", "周三", "3-4", "软件工程", "甘利", "图书馆5楼5机房", "3-19"),
...
/** 实践/实训课程（整周性质，某周整周停课，只作提示，不进时间线） */
export const PRACTICE_NOTE = "另记：JAVA 程序开发实训（黄勇，1 周，3-19 周内某周整周停课）";

/** 本学期上课周次区间（含），考试周另计 */
export const TERM_WEEK_RANGE: [number, number] = [3, 19];
